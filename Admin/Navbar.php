        ...
        <div class="container-fluid navbar-container">
            ...
            <div>
                <ul class="nav nav-pills">
                    ...
                    <li class="nav-item">
                        <a class="nav-link navbar-item nav-BookFlight" aria-current="page" href="./AddFlight.php">
                            Add Flight
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link navbar-item nav-Flights" aria-current="page" href="./Flights.php">
                            Flights
                        </a>
                    </li>
                    <?php
