...
if (isset($_POST['username']) && isset($_POST['password'])) {
    if ($result = $mysqli->query("SELECT * FROM users WHERE email = '" . $_POST['username'] . "' AND password = '" . md5($_POST['password']) . "'")) {
        ...
        <div class="login-container">
            <form action="login.php" method="post" class="login-form" id="loginForm">
                ...
                <a href="./Registration.php">
                    <button type="button" class="btn primary-outline action-button">New User? Register</button>
                </a>
                <a href="./Admin/Login.php">
                    <button type="button" class="btn primary-outline action-button">Admin Login</button>
                </a>
            </form>
        </div>
